      ...
      <div :class="['fixed inset-y-0 left-0 z-10 w-64 bg-white dark:bg-gray-800 shadow-lg mt-16 transform transition-transform duration-200 ease-in-out', sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0']">
        <div class="h-full overflow-y-auto">
          <nav class="mt-5 px-2 space-y-1">
            ...
            <router-link to="/admin/users" class="group flex items-center px-2 py-2 text-base font-medium rounded-md" :class="[$route.path === '/admin/users' ? 'bg-indigo-100 text-indigo-900 dark:bg-indigo-900/50 dark:text-indigo-300' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-700']">
              <svg class="mr-3 h-6 w-6" :class="[$route.path === '/admin/users' ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500']" fill="none" stroke="currentColor" viewBox="0 0 24 24">
