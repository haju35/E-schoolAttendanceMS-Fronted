            ...
            <tr v-for="family in families" :key="family.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex space-x-3">
                  <button @click="viewFamily(family)" class="text-blue-600 hover:text-blue-900">View</button>
                  <button @click="editFamily(family)" class="text-yellow-600 hover:text-yellow-900">Edit</button>
