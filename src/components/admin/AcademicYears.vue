<template>
  <div class="p-6">
    ...
    <div class="mb-6">
      ...
      <p class="text-gray-600">Manage school academic years and sessions</p>
    </div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="year in academicYears" :key="year.id" class="hover:bg-gray-50 transition">
...
const API = 'http://127.0.0.1:8000/api/admin/academic-years';
