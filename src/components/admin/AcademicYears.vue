                ...
                <div v-if="activeMenu === year.id" 
                  ...
                  <div class="flex justify-around p-2">
                    ...
                    <button @click="editYear(year)"
                      class="text-yellow-600 hover:text-yellow-900 dark:text-yellow-400 dark:hover:text-yellow-300 transition p-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded" 
                      title="Edit">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button @click="deleteYear(year.id)"
                      class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 transition p-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded" 
                      title="Delete">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
